...
module PGExtra::Operations::Enums
  ...
  class Base < PGExtra::Operation
    ...
    attribute :changes, :pg_extra_array_of_hashes, default: []
    attribute :values, :pg_extra_array_of_strings, default: []
    ...
    validates :changes, "PGExtra/all_items_valid": true, allow_nil: true
