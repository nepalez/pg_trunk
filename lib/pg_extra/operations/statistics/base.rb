...
module PGExtra::Operations::Statistics
  # @abstract
  # @private
  ...
  class Base < PGExtra::Operation
    ...
    attribute :expressions, :pg_extra_array_of_strings, default: []
    attribute :kinds, :pg_extra_array_of_symbols, default: []
    ...
    def generated_name
      ...
      @generated_name ||= begin
        ...
        PGExtra::QualifiedName.wrap("stat_rails_#{hashed_identifier}")
      end
    end
